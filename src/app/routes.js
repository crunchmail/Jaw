(function () {
    ...
    var Routes = function($routeProvider, $locationProvider) {
        ...
        .when('/contactlists', {
            templateUrl: 'views/clist/clistList.layout.html'
        })
        .when('/viewlist/add-contacts/:url', {
            templateUrl: 'views/clist/clistContacts.layout.html'
        })
        .when('/viewlist/edit/:url?', {
            templateUrl: 'views/clist/clistEdit.layout.html'
        })
        .when('/viewlist/contacts/:url', {
            templateUrl: 'views/clist/clistContacts.layout.html'
        })
        .when('/viewlist/:url/createform', {
            templateUrl: 'views/contactQueue/createContactForm.layout.html'
        })
        .when('/viewlist/:url/importcontact', {
            templateUrl: 'views/clist/clistImport.layout.html'
        })
        .when('/list-domains', {
